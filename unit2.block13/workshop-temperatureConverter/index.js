...
// TODO
// To convert the value from F to C,
//subtract 32 from the F value, then multiply it by 5/9.
function convertToCelsius(f) {
  return (f - 32) * 5 / 9;
  // return convertToCelsius = (f - 32) * 5/9 is redundant
}
...
function describeTemperature(f) {
  ...
  convertToCelsius = []
  if (f < 32) message = "is very cold"
  console.log(message)
}
createMessage(convertToCelsius2, message);
